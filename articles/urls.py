...
from .views import ArticleListView, ArticleDetailView, ArticleUpdateView, ArticleDeleteView, ArticleCreateView, ArticlesMainPageView
...
urlpatterns = [
    ...
    path("", ArticlesMainPageView.as_view(), name="articles"),
    path("list_articles/", ArticleListView.as_view(), name="list_articles"),
]